...
namespace TCLPromotion.Areas.Admin.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public TCLPromotionEntities DB = new TCLPromotionEntities();
                ...
                if ((file != null) && (file.ContentLength > 0) && !string.IsNullOrEmpty(file.FileName))
                {
                    ...
                    using (var package = new ExcelPackage(file.InputStream))
                    {
                        ...
                        for (int rowIterator = 2; rowIterator <= noOfRow; rowIterator++)
                        {
                            ...
                            try { phone = workSheet.Cells[rowIterator, 3].Value.ToString(); } catch (Exception) { phone = ""; }
                            ...
                            if (!string.IsNullOrEmpty(user) && !string.IsNullOrEmpty(password))
                            {
                                ...
                                try
                                {
                                    ...
                                    if (result.Succeeded)
                                    {
                                        ...
                                        u.Roles.Add(new IdentityUserRole() { UserId = asp.Id, RoleId = "Agent" });
                                        context.SaveChanges();
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    u.Roles.Add(new IdentityUserRole() { UserId = user.Id, RoleId = "Agent" });
                    context.SaveChanges();
